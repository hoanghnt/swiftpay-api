...
public class AuthService {
    ...
    public RegisterResponse register(RegisterRequest request) {
        ...
        // 3. Publish UserRegistered — written to the outbox, published to Kafka on
        // commit, consumed by wallet-service to create the Wallet asynchronously
        applicationEventPublisher.publishEvent(new UserRegisteredDomainEvent(user));
